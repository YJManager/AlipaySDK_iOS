#
#  Be sure to run `pod spec lint AlipaySDK_iOS.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/YJManager/AlipaySDK_iOS.git", :tag => "#{s.version}" }
...
#s.source_files  = "AlipaySDKIOS/AlipaySDK.framework/**/*"
  ...
  s.vendored_frameworks = "AlipaySDKIOS/AlipaySDK.framework"
